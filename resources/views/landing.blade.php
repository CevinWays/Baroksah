  ...
  <div class="master-slider ms-skin-default" id="masterslider"> 
    ...
    <div class="ms-slide slide-1" data-delay="14"> 
      ...
      <h3 class="ms-layer title2 white"
            ...
            data-duration="1000"
            data-delay="800"
            data-ease="easeOutExpo">Baroksah</h3>
      <h5 class="ms-layer title2 white"
        	style="left:100px; top: 315px;"
            data-type="text"
            data-effect="bottom(45)"
            data-duration="1000"
            data-delay="1100"
            data-ease="easeOutExpo">Investasi Reksadana</h5>
      <h3 class="ms-layer text1 white"
			style="left:100px; top:400px;"
			data-type="text"
            data-effect="bottom(45)"
            data-duration="1000"
            data-delay="1400"
            data-ease="easeOutExpo">Mulailah berinvestasi mulai dini, demi masa depan yang lebih baik.</h3>
      <div class="ms-layer btn5"
			style="left: 102px; top:500px;"
            data-type="text"
            data-effect="bottom(45)"
            data-duration="1000"
            data-delay="1700"
    ...
    <div class="ms-slide slide-2" data-delay="10"> 
      ...
      <h3 class="ms-layer title2 white text-center"
            ...
            data-delay="800"
            data-ease="easeOutExpo">Baroksah</h3>
      <h3 class="ms-layer text1 wide-100 white ful text-center"
			style="left:0px; top:360px;"
			data-type="text"
            data-effect="bottom(45)"
            data-duration="1000"
            data-delay="1100"
            data-ease="easeOutExpo">Solusi terbaik untuk anda yang ingin memulai ber-investasi.<br>
            Mulailah berinvestasi mulai dini, demi masa depan yang lebih baik</h3>
      <div class="ms-layer btn5 squre"
			style="left:500px; top: 480px;"
            data-delay="1400"
            data-duration="1000"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 m-bot-3 animate-in" data-anim-type="fade-in-right" data-anim-delay="100">
          ...
          <p class="white m-bot-2">Reksadana adalah Wadah untuk menghimpun dana dari masyarakat pemodal. Menghimpun dana dari masyarakat bukan perkara main-main. 
            Otoritas Jasa Keuangan (OJK) secara ketat sudah mengatur jenis perusahaan seperti apa saja yang dapat melakukan kegiatan penghimpunan dana, 
        ...
        <div class="col-md-5 animate-in" data-anim-type="fade-in-left" data-anim-delay="100">
          <div class="video-box">
            <div class="video-inner">
              <div class="image"><img src="images/reksadana.jpg" alt="" class="img-responsive"></div>
              <div class="video-body"> <a class="bla-1 video-link" href="https://www.youtube.com/watch?v=H-M6o6gFzVg"> <span class="icon-play"><i class="fa fa-play space-40"></i></span> </a> </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5 post-item m-bot-3">
          <div class="post-item-wrap">
            <div class="post-image sty-one"> <a href="#"> <img alt="" src="images/reksadana3.jpg" class="img-responsive"> </a> <span class="post-meta-category"><a href="">HOT</a></span> </div>
            <div class="post-item-description"> <span class="post-meta-date"><i class="fa fa-calendar-o"></i> Feb 13, 2018</span> <span class="post-meta-comments"><a href=""><i class="fa fa-comments-o"></i> 33 Comments</a></span>
              <h2><a href="#">Akibat DMO, Potensi Pendapatan Anak Usaha BUMI Lebih Kecil Rp3,4 Triliun</a></h2>
              <p>Sejumlah perusahaan batu bara mengaku tergerus marginnya akibat kebijakan pembatasan harga penjualan batu bara dalam negeri.</p>
              <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Baca</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="post-item">
          <div class="post-item-wrap">
            <div class="post-image sty-one"><a href="#"><img alt="" src="images/reksadana2.jpg" class="img-responsive"> </a> <span class="post-meta-category"><a href="">HOT</a></span> </div>
          </div>
        </div>
        </div>
        <div class="col-md-8 post-item">
        <div class="post-item-description nopad-both"> <span class="post-meta-date"><i class="fa fa-calendar-o"></i> Feb 13, 2018</span> <span class="post-meta-comments"><a href=""><i class="fa fa-comments-o"></i> 33 Comments</a></span>
              <h2><a href="#">PLN Resmi Setop Penawaran Obligasi Berkelanjutan II dan Sukuk Ijarah</a></h2>
              <p>PT Perusahaan Listrik Negara (Persero) alias PLN resmi menghentikan penawaran umum berkelanjutan II dan Sukuk Ijarah berkelanjutan II..</p>
              <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Baca</a></div>
            </div>
        </div></div>
        </div>
        ...
        <div class="post-item">
          <div class="post-item-wrap">
            <div class="post-image sty-one"><a href="#"><img alt="" src="images/reksadana1.jpg" class="img-responsive"> </a> <span class="post-meta-category"><a href="">HOT</a></span> </div>
          </div>
        </div>
        </div>
        <div class="col-md-8 post-item">
        <div class="post-item-description nopad-both"> <span class="post-meta-date"><i class="fa fa-calendar-o"></i> Jan 21, 2018</span> <span class="post-meta-comments"><a href=""><i class="fa fa-comments-o"></i> 33 Comments</a></span>
