    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="box-shadow: 0 5px 9px 0 #BDBDBD; border-color: white">
                <div class="uppercase text-center pad-20"><strong class="f-25">{{ __('Register') }}</strong></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('No Telp') }}</label>
